            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("edb3a1c8-e6f5-4a46-b876-7ab6c9ca47a7"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 16, 20, 9, 16, 207, DateTimeKind.Local).AddTicks(4608),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 20, 9, 16, 207, DateTimeKind.Local).AddTicks(4611),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 20, 9, 16, 207, DateTimeKind.Local).AddTicks(4615),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 20, 9, 16, 207, DateTimeKind.Local).AddTicks(4619),
                            Name = "New",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 20, 9, 16, 207, DateTimeKind.Local).AddTicks(4623),
                            Name = "Menu",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 16, 20, 9, 16, 207, DateTimeKind.Local).AddTicks(4567),
