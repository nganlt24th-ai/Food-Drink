            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ac7caa32-98d1-4d37-abf8-c7a381faa59a"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 12, 23, 33, 52, 840, DateTimeKind.Local).AddTicks(6538),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 12, 23, 33, 52, 840, DateTimeKind.Local).AddTicks(6544),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 12, 23, 33, 52, 840, DateTimeKind.Local).AddTicks(6551),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 12, 23, 33, 52, 840, DateTimeKind.Local).AddTicks(6557),
                            Name = "New",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 12, 23, 33, 52, 840, DateTimeKind.Local).AddTicks(6563),
                            Name = "Menu",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 12, 23, 33, 52, 840, DateTimeKind.Local).AddTicks(6472),
