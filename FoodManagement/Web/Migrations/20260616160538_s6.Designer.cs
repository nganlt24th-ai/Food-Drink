            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d0d7b309-5b2c-46f8-a5a4-cb653ffaf448"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 16, 23, 5, 37, 773, DateTimeKind.Local).AddTicks(8000),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 23, 5, 37, 773, DateTimeKind.Local).AddTicks(8003),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 23, 5, 37, 773, DateTimeKind.Local).AddTicks(8006),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 23, 5, 37, 773, DateTimeKind.Local).AddTicks(8008),
                            Name = "New",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 16, 23, 5, 37, 773, DateTimeKind.Local).AddTicks(8012),
                            Name = "Menu",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 16, 23, 5, 37, 773, DateTimeKind.Local).AddTicks(7960),
