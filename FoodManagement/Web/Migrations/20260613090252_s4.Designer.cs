            ...
            modelBuilder.Entity("Core.Database.Models.Authorized", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eb0f4a58-a1c1-431d-b626-d8d0066afcee"),
            ...
            modelBuilder.Entity("Core.Database.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 13, 16, 2, 47, 571, DateTimeKind.Local).AddTicks(4454),
                            Name = "Root"
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 13, 16, 2, 47, 571, DateTimeKind.Local).AddTicks(4458),
                            Name = "Authorized",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 13, 16, 2, 47, 571, DateTimeKind.Local).AddTicks(4463),
                            Name = "Nhóm quyền",
                        ...
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 13, 16, 2, 47, 571, DateTimeKind.Local).AddTicks(4466),
                            Name = "New",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        },
                        new
                        {
                            ...
                            CreatedBy = new Guid("e3fa3f30-1996-44fc-a68f-941c808e7394"),
                            CreatedOn = new DateTime(2026, 6, 13, 16, 2, 47, 571, DateTimeKind.Local).AddTicks(4468),
                            Name = "Menu",
                            ParentId = new Guid("f4fae31d-33fa-46f5-95d2-5339a77676a7")
                        });
                });
            ...
            modelBuilder.Entity("Core.Database.Models.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2026, 6, 13, 16, 2, 47, 571, DateTimeKind.Local).AddTicks(4285),
